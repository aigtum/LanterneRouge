    ...
    if (direction == 1) {
      if (j == 0) {
        tile = new Tile(
          ...
          this.y * 2 + (lineNum - 1) * this.tileHeight * 3 + this.tileHeight,
          this.tileWidth,
          this.tileHeight,
          [i, j],
          type,
        ...
        tile = new Tile(
          this.x + (i - tilesPerLength * (lineNum - 1)) * this.tileWidth,
          this.y * 2 + (lineNum - 1) * this.tileHeight * 3,
          this.tileWidth,
          this.tileHeight,
          [i, j],
          type,
    ...
    if (direction == -1) {
      if (j == 0) {
        tile = new Tile(
          ...
          tilesPerLength * this.tileWidth -
            (i - tilesPerLength * (lineNum - 1)) * this.tileWidth -
            this.tileWidth * 0.5,
          this.y * 2 + (lineNum - 1) * this.tileHeight * 3 + this.tileHeight,
          this.tileWidth,
          this.tileHeight,
